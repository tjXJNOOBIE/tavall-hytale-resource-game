...
const PAGE_KEYS = {
  upgrades: "com.tavall.resourcegame.ui.CastleUpgradesPage",
  debug: "com.tavall.resourcegame.ui.DebugNavigatorPage",
  interior: "com.tavall.resourcegame.ui.InteriorMainPage"
};
