...
import com.tavall.hytale.resourcegame.liveops.config.GameSystemToggle;
import com.tavall.hytale.resourcegame.liveops.config.LiveConfigChangeRequest;
import com.tavall.hytale.resourcegame.liveops.config.LiveConfigDisabledException;
import com.tavall.hytale.resourcegame.liveops.config.LiveConfigRolloutStrategy;
import com.tavall.hytale.resourcegame.liveops.config.LiveConfigType;
import com.tavall.hytale.resourcegame.liveops.gui.GlobalGuiChangeRequest;
...
public final class LiveOpsRuntimeIntegrationTest {
    ...
    void liveConfigChangeUpdatesMemoryPublishesAndFiresGameEvent() {
        ...
        LiveOpsRuntime runtime = LiveOpsRuntimeFactory.createInMemoryRuntime(eventRuntime.dispatchHandler());
