...
public final class ControlCommandValidationHandler {
    private final ControlCommandRegistry commandRegistry;

    public ControlCommandValidationHandler(ControlCommandRegistry commandRegistry) {
    ...
    public List<String> validateCommand(ControlCommand command) {
        ...
        try {
            definition = commandRegistry.definition(command.commandType());
