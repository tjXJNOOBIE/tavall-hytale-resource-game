...
public final class CitizenTrainingEligibilityHandler {
    ...
    public void requireCanStartTraining(CitizenData citizen) {
        if (!lifeStageEligibilityHandler.canTrain(citizen.ageStage())) {
    ...
    public void requireCanPromote(CitizenData citizen) {
        if (!lifeStageEligibilityHandler.canPromoteToTroop(citizen.ageStage())) {
