...
public final class DiscordTcpControlCommandClient implements IDiscordControlCommandClient, IDiscordFrontendDomain, IDependencyInjectableConcrete {
    ...
    public FrontendCommandVerificationResult submitCommand(FrontendCommandEnvelope envelope) {
        ...
        String host = java.net.URI.create(getDiscordBotConfig().controlIngressUrl()).getHost();
        int port = java.net.URI.create(getDiscordBotConfig().controlIngressUrl()).getPort();
