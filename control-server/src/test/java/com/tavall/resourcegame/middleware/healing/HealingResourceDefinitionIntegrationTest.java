...
public final class HealingResourceDefinitionIntegrationTest {
    ...
    @Test
    void resourcesResolveForAllPlatformsWithFallbackWhenPlatformArtIsMissing() {
        InMemoryGlobalAssetRepository assetRepository = new InMemoryGlobalAssetRepository();
        ...
        for (GamePlatform platform : new GamePlatform[]{GamePlatform.MINECRAFT, GamePlatform.HYTALE, GamePlatform.ROBLOX, GamePlatform.DISCORD}) {
