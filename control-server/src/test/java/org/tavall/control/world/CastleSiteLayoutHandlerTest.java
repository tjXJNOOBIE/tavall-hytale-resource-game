...
public final class CastleSiteLayoutHandlerTest {
    @Test
    void layoutPlacesResourceNodesBehindThePromptLaneAndAroundTheCastle() {
        CastleSiteLayout layout = new CastleSiteLayoutHandler().createLayout(new CastleLocationData("default", 20.0, 64.7, 40.0));
