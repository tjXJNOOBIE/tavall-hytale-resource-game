...
public final class CompanionTrainingService implements ICompanionDomain {
    public CompanionTrainingService() {
    }
    ...
    public CompanionTrainingService(CompanionRepository repository, CompanionStatsService statsService, CompanionLevelingService levelingService) {
        ...
        registerCompanionLevelingService(levelingService);
    }
    ...
    public CompanionData applyXp(CompanionData companion, long xp, long nowEpochMillis) {
        ...
        CompanionLevelingService levelingService = getCompanionLevelingService();
        ...
        CompanionData withStats = withProgress.withProgress(newLevel, newXp, getCompanionStatsService().calculateCompanionStats(withProgress), nowEpochMillis);
