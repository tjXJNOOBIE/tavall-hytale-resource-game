 ...
 */
public final class ResourceNodeHandler implements IResourceNodeHandler, IDependencyInjectableConcrete {
    private static final Logger LOGGER = Logger.getLogger(ResourceNodeHandler.class.getName());
