...
public final class CompanionWallDefenseHandler implements ICompanionDomain {
    public CompanionWallDefenseHandler() {
    }

    public CompanionWallDefenseHandler(CompanionRepository repository) {
