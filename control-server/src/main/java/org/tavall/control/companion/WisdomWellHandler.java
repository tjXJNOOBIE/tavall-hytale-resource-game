...
public final class WisdomWellHandler implements CompanionDomain {
    ...
    public WisdomWellHandler(CompanionRepository repository, CompanionSkillHandler skillHandler) {
    ...
    public List<CompanionSkill> getAvailableWisdomUpgrades(UUID ownerPlayerId, UUID companionId) {
        CompanionData companion = ownedCompanion(ownerPlayerId, companionId);
        return getCompanionSkillHandler().availableSkillsFor(companion);
    }
