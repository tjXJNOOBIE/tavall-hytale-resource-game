 ...
 */
public final class InfrastructureHealthHandler implements IInfrastructureHealthHandler, IDependencyInjectableConcrete {
    private static final Logger LOGGER = Logger.getLogger(InfrastructureHealthHandler.class.getName());
    ...
    public InfrastructureHealthHandler(CacheConfig cacheConfig, DatabaseConfig databaseConfig) {
        this(cacheConfig, databaseConfig, InfrastructureMetricsRecorder.defaultRecorder());
    }

    public InfrastructureHealthHandler(
