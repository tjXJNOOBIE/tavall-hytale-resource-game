...
public interface IControlServerDomainGenerated {
    ...
    default ControlPlaneInteractionHandler getControlPlaneInteractionHandler() {
        return DependencyLoaderAccess.findInstance(ControlPlaneInteractionHandler.class);
    }
