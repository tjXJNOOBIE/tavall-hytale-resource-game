 ...
 */
public final class PlayerProfileHandler implements IPlayerProfileHandler, IDependencyInjectableConcrete {
    private static final Logger LOGGER = Logger.getLogger(PlayerProfileHandler.class.getName());
    ...
    public PlayerProfileHandler(PlayerProfileStore repository, SemanticCache cache, JacksonCacheCodec<PlayerProfile> codec) {
