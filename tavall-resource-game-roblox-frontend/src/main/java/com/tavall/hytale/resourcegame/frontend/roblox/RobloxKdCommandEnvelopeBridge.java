...
public final class RobloxKdCommandEnvelopeBridge {
    ...
    public RobloxKdCommandEnvelopeBridge() {
        this(new RobloxFrontendCommandEnvelopeFactory(), new FrontendKdCommandInputFormatter());
    }

    public RobloxKdCommandEnvelopeBridge(
            RobloxFrontendCommandEnvelopeFactory envelopeFactory,
