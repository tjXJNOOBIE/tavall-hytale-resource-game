...
public final class RobloxFrontendCommandEnvelopeFactory implements FrontendCommandEnvelopeFactory, IRobloxFrontendCommandEnvelopeFactory, com.tjxjnoobie.api.dependency.IDependencyInjectableConcrete {
    @Override
