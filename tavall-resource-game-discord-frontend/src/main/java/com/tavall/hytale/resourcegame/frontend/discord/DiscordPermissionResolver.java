...
public final class DiscordPermissionResolver {
    private final DiscordPermissionMapping permissionMapping;

    public DiscordPermissionResolver(DiscordPermissionMapping permissionMapping) {
        this.permissionMapping = permissionMapping == null ? DiscordPermissionMapping.empty() : permissionMapping;
    }
