...
public final class FrontendTcpControlCommandClient implements IFrontendControlCommandClient, IDependencyInjectableConcrete {
    ...
    public FrontendCommandVerificationResult submitCommand(FrontendCommandEnvelope envelope) {
        ...
        URI controlBridgeUri = frontendControlConfig().controlIngressUri();
    ...
    private IFrontendControlConfig frontendControlConfig() {
        return DependencyLoaderAccess.requireInstance(
                IFrontendControlConfig.class,
                "No frontend control config registered for the frontend TCP control client."
        );
    }
