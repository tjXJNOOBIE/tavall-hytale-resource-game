...
import com.tavall.hytale.resourcegame.frontend.discord.DiscordKdCommandEnvelopeBridge;
import com.tavall.hytale.resourcegame.frontend.hytale.HytaleKdCommandEnvelopeBridge;
import com.tavall.hytale.resourcegame.frontend.minecraft.MinecraftKdCommandEnvelopeBridge;
import com.tavall.hytale.resourcegame.frontend.roblox.RobloxKdCommandEnvelopeBridge;
...
final class FrontendModuleCommandIngressIntegrationTest {
    ...
    @Test
    void hytaleKdBridgeReachesControlIngressForLocalUiVerification() {
    ...
    @Test
    void robloxKdBridgeVerifiesMarketCategoryThroughControlIngress() {
        ControlCommandRuntime runtime = controlServerModule.createInMemoryRuntime();
        ...
        assertEquals(FrontendCommandVerificationState.LOCAL_ACTION_ALLOWED, result.state());
        assertEquals("market", result.metadata().get("verifiedCategory"));
        assertFalse(runtime.auditLogRepository().findRecentAuditLogs(10).isEmpty());
    }
