...
final class MinecraftServerSnapshotIngressControllerTest {
    ...
    void acceptsAndReturnsLatestBukkitServerSnapshot() throws Exception {
        MinecraftServerSnapshotIngressHandler handler = new MinecraftServerSnapshotIngressHandler();
        MockMvc mockMvc = MockMvcBuilders.standaloneSetup(new MinecraftServerSnapshotIngressController(handler)).build();
