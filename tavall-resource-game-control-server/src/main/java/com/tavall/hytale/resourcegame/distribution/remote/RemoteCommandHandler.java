...
public final class RemoteCommandHandler {
    ...
    private final RemoteCommandPolicy commandPolicy;

    public RemoteCommandHandler(RemoteCommandPolicy commandPolicy) {
    ...
    public RemoteCommandResult runRemoteCommand(RemoteTarget target, RemoteCommand command) {
        ...
        List<String> validationErrors = commandPolicy.validate(command);
